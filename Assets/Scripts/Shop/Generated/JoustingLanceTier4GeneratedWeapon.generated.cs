public sealed class JoustingLanceTier4GeneratedWeapon : ShopWeaponDefinition
{
    public override string Id => "weapon.jousting_lance.tier_4";
    ...
    public override int BasePrice => 132;
