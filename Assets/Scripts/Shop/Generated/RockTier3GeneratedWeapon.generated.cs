public sealed class RockTier3GeneratedWeapon : ShopWeaponDefinition
{
    public override string Id => "weapon.rock.tier_3";
    ...
    public override float AttackCooldown => 1.53f;
