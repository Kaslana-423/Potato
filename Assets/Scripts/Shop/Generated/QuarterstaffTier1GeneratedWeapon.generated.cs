public sealed class QuarterstaffTier1GeneratedWeapon : ShopWeaponDefinition
{
    public override string Id => "weapon.quarterstaff.tier_1";
    ...
    public override string DamageScalingText => "75% 50%";
