public sealed class DEXTroyerTier4GeneratedWeapon : ShopWeaponDefinition
{
    public override string Id => "weapon.dex_troyer.tier_4";
    public override string DisplayName => "DEX-troyer";
