public sealed class QuarterstaffTier3GeneratedWeapon : ShopWeaponDefinition
{
    public override string Id => "weapon.quarterstaff.tier_3";
    ...
    public override string DamageScalingText => "100% 85%";
