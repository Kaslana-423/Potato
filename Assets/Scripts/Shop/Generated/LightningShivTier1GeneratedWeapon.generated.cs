public sealed class LightningShivTier1GeneratedWeapon : ShopWeaponDefinition
{
    public override string Id => "weapon.lightning_shiv.tier_1";
    ...
    public override float CritChance => 4f;
