public sealed class TorchTier4GeneratedWeapon : ShopWeaponDefinition
{
    public override string Id => "weapon.torch.tier_4";
    ...
    public override float AttackCooldown => 0.8f;
