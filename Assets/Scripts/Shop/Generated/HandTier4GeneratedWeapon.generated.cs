public sealed class HandTier4GeneratedWeapon : ShopWeaponDefinition
{
    public override string Id => "weapon.hand.tier_4";
    ...
    public override float AttackCooldown => 0.71f;
